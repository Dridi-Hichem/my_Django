...
function monkeyTrouble(aSmile, bSmile) {
    //Code Goes Here
    return !Boolean(aSmile ^ bSmile);
}

console.log("Monkey Trouble:");
...
function makeBricks(small, big, goal){
  //Code Goes Here
  return Math.floor(goal, small) == 1 || Math.floor(goal, (5 * big)) == 1 || Math.floor(goal, (small + 5 * big)) == 1;
}

console.log("Make Bricks:");
